...
/**
 * Removes extension from file
 * @param {string} documentOwnerId - owner ID
 * @param {string} currentUserId - current User's ID ID
 * @returns {Boolean} Returns if user is owner
 */
exports.isCurrentUserDocumentOwner = (documentOwnerId, currentUserId) =>
  documentOwnerId.toString() === currentUserId.toString()
